            ...
            try :
                ...
                try :
                    if self.driver.find_element(By.CSS_SELECTOR,
                                                modal_guest_name[0]).is_displayed():
                        #Modal Customer Name
                        self._insert_text("/html/body/body/div[1]/div[4]/div/div/div/textarea",
                                        ''.join(random.choice(string.ascii_letters) for _ in range(10)),
                                        record_time=True) # Insert Random Customer Name
                        self._click_element("/html/body/body/div[1]/div[4]/div[3]/div/footer/div[1]",
                                            record_time=True) # Submit Modal Guest Name
                except:
                    pass
                ...
                try :
                    if self.driver.find_element(By.CSS_SELECTOR, 
                                                "body > div.pos > div.popups > div:nth-child(2) > div > header").is_displayed() :
                ...
                self._click_element(elem_pm+f"[{random.randint(1, len(payment_method))}]",
